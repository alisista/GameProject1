...
public class ImageSaveCharacter : SetVoid1
{
    static int IMG_MAX = 10;
    public int img_max() { return IMG_MAX; }
    public ImageData1[] img1 = new ImageData1[IMG_MAX];

    public int[] load_type1 = new int[IMG_MAX];

    public ImageSaveCharacter(Summary1 s1)
    {
        set1(s1);
                ...
                if (load_type1[slot1] == 0)
                {
...

                    {
...

                        {
                            ...
                            st2 = "character/cs" + (m1.add_space_str1("" + (type1), 4, 0, "0")) + ".png";
