...
//味方キャラクターのウインドウ画面の画像保管クラス

public class ImageSaveCharacterWindow : SetVoid1
{
    static int CHARACTER_WINDOW_IMG_MAX = 60;
    public int img_max() { return CHARACTER_WINDOW_IMG_MAX; }
    public ImageData1[] img1 = new ImageData1[CHARACTER_WINDOW_IMG_MAX];

    public int[] load_type1 = new int[CHARACTER_WINDOW_IMG_MAX];
                ...
                if (load_type1[slot1] == 0)
                {
...

                    {
...

                        {
                            ...
                            st2 = "character_window/cw" + (m1.add_space_str1("" + (type1), 4, 0, "0")) + ".png";
