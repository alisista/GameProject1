...
public class ImageSaveEnemy : SetVoid1
{
    static int ENEMY_IMG_MAX = 24;
    public ImageData1[] img1 = new ImageData1[ENEMY_IMG_MAX];

    public int[] load_type1 = new int[ENEMY_IMG_MAX];
    ...
    {
        for (int t1 = 0; t1 < ENEMY_IMG_MAX; t1++)
        {
                ...
                if (load_type1[slot1] == 0)
                {
                    ...
                    
                    {
                        ...
                        
                        {
                            ...
                            st2 = "enemy1/m" + (m1.add_space_str1("" + (type1), 4, 0, "0")) + ".png";
